 const Footer = {
     render() {
       ...
       <div class="logo-footer">
          <a href="#"><img src="img/logo_b207d148-0a8f-4f11-bbc3-c4e10cfa2211_200x.png" alt=""></a>
          <div class="address-1">
             <p>Flowers always make people better, happier, they are sunshine and medicine for the soul </p>
 
             <p> +84 373415145</p>
             <p> Nguyen co Thach , Ham Nghi , Nam Tu Niem</p>
          </div>
       </div>
       <div class="Support">
          <h3>Support</h3>
       ...
       <div class="Contact-us">
          ...
          <input type="text" placeholder="Enter your email and phone">
          <button>Send</button>
       </div>
